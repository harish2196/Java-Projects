...
//	public static ArrayList<User> retrieveRegisterInfo(String empCode) throws SQLException, ClassNotFoundException {
//		ArrayList<User> userList = new ArrayList<>();
//		Connection  connection = DBManager.getConnection();
//		String retrieve= "SELECT emp_code, username FROM Employee_details";
